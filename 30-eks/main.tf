...
#       iam_role_additional_policies = {
#         EBS = "arn:aws:iam::aws:policy/AmazonEBSCSIDriverPolicyV2" #arn:aws:iam::aws:policy/AmazonEBSCSIDriverPolicyV2
#         EFS = "arn:aws:iam::aws:policy/service-role/AmazonEFSCSIDriverPolicy" #arn:aws:iam::aws:policy/service-role/AmazonEFSCSIDriverPolicy
#       }
#       min_size     = 2
#       max_size     = 2
#       desired_size = 2
...
# }
  ...
  #     # Starting on 1.30, AL2023 is the default AMI type for EKS managed node groups
  #     ami_type       = "AL2023_x86_64_STANDARD"
  #     instance_types = ["t3.small","t3.medium","m5.xlarge","m4.xlarge"] # change for t3.small only if required
  #     capacity_type = "SPOT"
